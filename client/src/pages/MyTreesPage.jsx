...
export default function MyTreesPage() {
  ...
  const posts = activeTab === 'watered'
    ? (myWatered.length ? myWatered : wateredList)
    : activeTab === 'planted'
    ? (myPlanted.length ? myPlanted : MY_PLANTED)
    : MY_BRANCHES
  ...
  return (
    ...
    >
      ...
      >
        {[
          { val: (stats.planted || STATS.planted),  label: '🌳 Planted' },
          { val: (stats.watered || STATS.watered),  label: '💧 Watered' },
          { val: (stats.branches || STATS.branches), label: '🌿 Branches' },
        ].map((s, i) => (
